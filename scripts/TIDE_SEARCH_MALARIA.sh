...
DATA_FILE_ORIGINAL=ms_data/v07548_UofF_malaria_TMT_10.ms2
DATA_FILE_BOLTZMATCH_LR=ms_data/v07548_UofF_malaria_TMT_10_boltzmatch_lowres.ms2
DATA_FILE_BOLTZMATCH_HR=ms_data/v07548_UofF_malaria_TMT_10_boltzmatch_highres.ms2

FIX_PARAM="--mz-bin-offset 0.4 --precursor-window 50 --precursor-window-type ppm --top-match 1 --concat T --overwrite T --num-threads 1 --use-neutral-loss-peaks F --use-flanking-peaks F --min-peaks 10 --max-precursor-charge 9"

INDEX=$PATH/MALARIA_IDX
TAXON=MALARIA
